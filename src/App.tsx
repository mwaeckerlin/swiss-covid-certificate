    ...
    <>
      ...
      <div onClick={() => { setEdit(false); setState(Verify.INFO) }} onKeyDown={e => { if (e.key === "Enter") setEdit(false) }}>
        ...
        <main>
          ...
          <div className={"infobox " + state.toString()}>
            {state === Verify.INFO
            ...
            {state === Verify.INFO
              ...
              : state === Verify.LOADING
                ? <div>Das Zertifikat wird geprüft</div>
                : <div className="fat">Prüfung erfolgreich</div>}
          </div>
          <div className={"infobox gueltigkeit " + state.toString()}>
            <table>
              <tr>
